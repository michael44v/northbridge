          ...
          <div className="pt-8 border-t border-gray-200">
            <div className="bg-chase-light/50 p-6 rounded-2xl border border-chase-border/50">
              ...
              <p className="text-sm text-gray-500">
                If you no longer have access to this email, please contact our 24/7 priority support at <span className="text-chase-blue font-bold">support@meridiantrustbank.com</span>
              </p>
            </div>
          </div>
        </div>
