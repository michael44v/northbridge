  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500">Add funds to your Meridian Trust USD account</p>
      </div>
        ...
        {step === 2 && (
          <div className="p-8 space-y-6">
            ...
            <div className="space-y-4">
              {[
                { label: 'Bank Name', value: 'Meridian Trust Partner Bank' },
                { label: 'Account Name', value: 'Meridian Trust Settlements' },
